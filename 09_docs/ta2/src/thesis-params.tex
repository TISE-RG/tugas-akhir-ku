...
\newcommand{\DocType}{DISERTASI}  % TUGAS AKHIR / TESIS / DISERTASI
\newcommand{\DegreeLong}{Doktor}  % Magister Teknik / Doktor, dll.
\newcommand{\DegreeShort}{Dr.}           % M.T. / Dr. / Ph.D., dll.
...
\newcommand{\AuthorNIM}{01234567890}
